...
const Dashboard = () => {
    const [activeIndex, setActiveIndex] = useState(1); // Default to 1 for Dashboard
    ...
    return (
        <div className="flex flex-col ">
            ...
            <main className="flex bg-black w-full min-h-screen gap-12 px-0 lg:px-8 py-12">
                ...
                <div
                    className="flex flex-col gap-6 lg:rounded-2xl bg-background  lg:w-3/4 text-white py-5 px-6 ml-auto">
